...
if __name__ == '__main__':
    ...
    dataFrameSingleLabel = dataFrameSingleLabel.drop('label_INH', axis=1)
    dataFrameSingleLabel = dataFrameSingleLabel.drop('label_RIF', axis=1)
    dataFrameSingleLabel = dataFrameSingleLabel.drop('label_EMB', axis=1)
    dataFrameSingleLabel = dataFrameSingleLabel.drop('label_PZA', axis=1)
    for i in range(-4,0):
